...
private:
	...
	size_t currentId;
	hash_map<size_t, shared_ptr<Input>> inputMap;
	hash_map<size_t, shared_ptr<NetworkNode>> idMap;
	hash_map<size_t, size_t> inDegreeMap;
	hash_map<size_t, shared_ptr<XMLDataParser>> dataFileMap;
