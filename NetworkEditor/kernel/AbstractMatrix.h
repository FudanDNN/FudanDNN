...
public:
	...
	virtual void setAllValue(double value){};
	...
	virtual shared_ptr<AbstractMatrix> add_inplace(size_t, size_t, size_t, size_t, 
		shared_ptr<AbstractMatrix>, size_t, size_t, size_t, size_t, double val) { return shared_from_this(); };
